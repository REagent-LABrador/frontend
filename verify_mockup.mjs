...
// Contract 8: the artifact is self-contained and cannot issue network requests.
...
const forbiddenSourcePatterns = [
  ...
  [/\b(?:fetch|XMLHttpRequest|WebSocket|EventSource|importScripts)\b/i, "network API"],
...
console.log("  Self-contained: no external assets, remote URLs, network APIs, or eval-like execution");
